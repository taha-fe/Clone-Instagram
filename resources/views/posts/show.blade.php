                    ...
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="card-body px-2" style="overflow-y: auto; overflow-x: hidden;">
                            ...
                            <div class="row">
                                ...
                                {{-- <button type="button" class="btn btn-danger"  ><a href="{{ route('posts.delete', ['post_id' => $post->id]) }}">Supprimer</a> </button> --}}

                                <div class="d-inline mx-3 mt-5" >
                                    <a href= "{{ route('posts.delete', ['post_id' => $post->id]) }}" name="delete" class="btn btn-danger">
