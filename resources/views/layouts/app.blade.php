        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container px-2">
                ...
                <a href="{{ url('/') }}" class="navbar-brand">
                    <img src="{{asset('svg\instagram.svg.webp')}}"  width="35px" class="pr-3" style="border-right: solid 1px #333;" alt="InstaClone Logo" >
                ...
                <div class="navbar-collapse collapse justify-content-stretch" id="navbar5">
                    ...
                    <form  orm action="/search" method="POST" role="search" class="m-auto d-inline w-80">
                        @csrf
