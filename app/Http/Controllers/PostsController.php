...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        //     // $comms=$post->comments->orderBy('id', 'DESC')->skip(0)->take(3)->all();
        //     $comms=$post->comments->take(4)->sortByDesc('id')->all();
    ...
    public function getDeletePost($post_id){
        ...
        $post->delete();
        return redirect()->route('profile.index',['user' => auth()->user()]) ->with(['message' => 'Successfully deleted!']);
    }
